...
imagen = cv2.imread('informe-fotos\minador1.jpg')
...
red_low = np.array([19, 20, 100], dtype=np.uint8)
red_high = np.array([110, 255, 255], dtype=np.uint8)
...
contornos,_ = cv2.findContours(maskI, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
